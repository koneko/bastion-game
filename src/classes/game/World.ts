...
export default class World {
    ...
    public async init(mapFileURL: string) {
        ...
        this.container = new Viewport({
            screenWidth: Engine.app.canvas.width,
            screenHeight: Engine.app.canvas.height,
            worldWidth: 10000,
            worldHeight: 10000,
            events: Engine.app.renderer.events, // the interaction module is important for wheel to work properly when renderer.view is placed or scaled
        });
